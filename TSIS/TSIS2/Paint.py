...
while True:
    ...
    if drawing and start_pos:
        ...
        if current_tool in shape_tools:
            draw_shape(screen, current_tool, current_color, start_pos, (mx, my), bsize)
